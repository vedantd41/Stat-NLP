...
class SpeechesClassificationDataset(Dataset):
    """
    Dataset class for text classification task using either Simple or WordPiece tokenizer.
    This is the dataset you will use to train your encoder and classifier jointly, 
    end-to-end for the text classification task.

    Args:
        tokenizer (Tokenizer): The tokenizer used to encode the text (either SimpleTokenizer or WordPieceTokenizer).
...
class LanguageModelingDataset(torch.utils.data.Dataset):
    """
    Dataset class for language modeling task using either Simple or WordPiece tokenizer.
    This is the dataset you will use to train your encoder for the language modeling task.
